...
class config:
    ...
    # Simulations
    NUM_EVS = 20 #config_data.get("NUM_EVS", 20)
    NUM_CLUSTERS = 5
    SIMULATION_DAYS =  1 # _config_data.get("SIMULATION_DAYS", 30)
    SIMULATION_START_DATE = "2024-01-16" # _config_data.get("SIMULATION_START_DATE", "2024-03-01")
    USE_SYNTHETIC = True
